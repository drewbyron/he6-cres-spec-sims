...
def load_trap_profile(filename,):
    ...
    with open(data_file,"r") as read_file:
        try:
            ...
            field_scales = config_dict["field_scales"]
        except:
            print('Loaded file "{}" does not contain a valid trap profile config dictionary'.format(filename))
            return False
            
    print("Trap profile {} loaded".format(filename))
    ...
    trap_profile = Trap_profile(list_coils,main_field,field_scales)
